...
public class Frontend implements FrontendInterface{
    ...
    */
    ...
    public String generateShortestPathResponseHTML(String start, String end){
        ...
        return "<p>The path starts at " + start + " and ends at " + end + "</p>" + pathHTML + "<p>The total travel time is " + String.valueOf(maxTime) + "</p>";
    }
    ...
    public String generateReachableFromWithinResponseHTML(String start, double travelTime){
        ...
        String placesHTML = "<ul>";
        for(String place : places){
            placesHTML += "<li>" + place + "</li>";
        }
        placesHTML += "</ul>";
